...
void ext_adv_evt_end_handler(struct ll_evt *evt);

void ext_adv_evt_terminate_handler(struct ll_evt * evt);

enum ll_evt_start_type htimer_ext_adv_evt_start(struct ll_evt *evt);

enum ll_evt_transition_type htimer_ext_adv_tx_end(struct ll_evt *evt);
