...
void ll_sync_per_adv_start(struct sync_env *env,uint32_t anchor,enum ble_phy phy,bool tx_coded_125k);
...
struct pkt_info htimer_sync_evt_header_rx(struct ll_evt *evt);
