...
void ll_ext_scan_env_init(void);
...
void ext_scan_evt_end_handler(struct ll_evt *evt);

void ext_scan_evt_terminate_handler(struct ll_evt * evt);

enum ll_evt_start_type htimer_ext_scan_evt_start(struct ll_evt *evt);
...
enum ll_evt_transition_type htimer_ext_scan_evt_sync_timeout(struct ll_evt *evt);
