...
XIP_BANNED void lsqspi_direct_read_config(struct lsqspi_direct_read_config_param *param)
{
...
#if (defined(BOOT_ROM))
XIP_BANNED static void lsqspi_operation_wait()
{
    LSQSPI->CFG;
    LSQSPI->CFG;
    LSQSPI->CFG;
...
XIP_BANNED static void stig_read_start(struct stig_start_param *param,uint8_t start_length,bool hold_cs,bool quad_data)
{
...
XIP_BANNED static void stig_read_continue(uint32_t *data,uint16_t size,bool quad_data)
{
...
XIP_BANNED static void stig_rd_wr(struct lsqspi_stig_rd_wr_param *param,
...
XIP_BANNED void lsqspi_stig_read_data(struct lsqspi_stig_rd_wr_param *param)
{
    stig_rd_wr(param,stig_read_start,stig_read_continue);
}

XIP_BANNED static void stig_write_start(struct stig_start_param *param,uint8_t start_length,bool hold_cs,bool quad_data)
{
    LSQSPI->STIG_CMD = FIELD_BUILD(LSQSPI_CMD_OPCODE,param->opcode) | FIELD_BUILD(LSQSPI_OPCODE_EN, param->opcode_en) | FIELD_BUILD(LSQSPI_DATA_XFER_TYPE, quad_data)
        | FIELD_BUILD(LSQSPI_ADDR_EN, param->addr_en) | FIELD_BUILD(LSQSPI_ADDR_XFER_TYPE, param->quad_addr) 
        | FIELD_BUILD(LSQSPI_NUM_DUMMY_BYTES, param->dummy_bytes) | FIELD_BUILD(LSQSPI_DUMMY_EN, param->dummy_bytes_en)
...
XIP_BANNED static void stig_write_continue(uint32_t *data,uint16_t size,bool quad_data)
{
...
XIP_BANNED void lsqspi_stig_write_data(struct lsqspi_stig_rd_wr_param *param)
{
    stig_rd_wr(param,stig_write_start,stig_write_continue);
}

XIP_BANNED void lsqspi_stig_write_register(uint8_t opcode,uint8_t *data,uint8_t length)
{
...
XIP_BANNED void lsqspi_stig_send_command(uint8_t opcode)
{
...
XIP_BANNED void lsqspi_stig_read_register(uint8_t opcode,uint8_t *data,uint8_t length)
{
